...
public class HomeBarraLateral {
    ...
    public Parent getRoot(Stage primaryStage) {
        // ATUALIZADO: O construtor agora recebe a ação para atualizar a view.
    ...
    private BorderPane createSidebar(Stage primaryStage) { 
        ...
        // ATUALIZADO: O botão do Clube agora usa a nova imagem e o novo construtor.
    ...
    private Button createNavButtonWithIcon(String text, String iconPath, ProvedorView provider) {
        ...
        // --- LÓGICA DE AJUSTE ORIGINAL MANTIDA ---
        if ("Clube Fidelidade".equals(text)) {
            // Tamanho especial para o ícone do Clube Fidelidade
            iconView.setFitHeight(30);
            iconView.setFitWidth(35);
        } else {
            // Tamanho padrão para todos os outros ícones
            iconView.setFitHeight(30);
            iconView.setFitWidth(35);
        }
